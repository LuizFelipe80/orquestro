...
public class UserRole implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "role_grantable_roles", joinColumns = @JoinColumn(name = "role_id"), inverseJoinColumns = @JoinColumn(name = "grantable_role_id"))
	...
	public UUID getModelGUID() {
		return modelGUID;
	}

	public void setModelGUID(UUID modelGUID) {
